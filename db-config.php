...
define('SQL_HOST','localhost');define('SQL_USER','stuchx');define('SQL_PASS','dUXwB4xBQDqfbWsR');define('SQL_DB','stuchx');define('S_PATH','http://localhost/com/stuchx/b/b/');define('SERVER_PATH','/com/stuchx/b/b');
/* ================================================================================================================================ */
...
$score = array(	"EDC" => 6,
		...
		"MOD" => 1,
		"OTH" => 0);
$roles = array(	"Editor-in-Cheif"=>"EDC",
		"Editor"=>"EDT",
