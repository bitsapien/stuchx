...
role_update($mysqli); // role deletions
...
if($_SESSION['id']!="") {
$write_php = '   <li>
                    <a href="write.php" title="Write Post" > <span class="fa fa-pencil"></span></a>
                </li>
';
$user_php = '    <li>
...
';
if($_SESSION['incomplete'] == 'true') {
$notice = '<div class="alert alert-danger center alert-dismissible" role="alert"> <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button> You have an incomplete profile. For accessing additional options like adding a post, complete your 
  <a href="edit_profile.php" class="alert-link">profile</a>.<p> But in case, you have registered to like or comment, you may very well ignore this.
</div>';
$write_php = '';
$user_php = '';
}
	...
	$nav = '<!-- Sidebar -->
        <div id="sidebar-wrapper">
		    ...
		    <a href="edit_profile.php" title="'.$_SESSION['name'].'" ><img class="dp" src="'.$_SESSION['dp'].'" ></a>
                ...
                <li>
                    <a href="dash.php" title="Home" > <span class="fa fa-home"></span></a>
                </li>
		'.$user_php.$write_php.'
		<hr>
                <li>
	...
	$nav = '<!-- Sidebar -->
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav sidebar-header">
                ...
                <li>
                    <a href="#" data-toggle="modal" data-target="#register" title="Register" ><span class="fa fa-anchor"></span></a>
                </li>
            </ul>
        </div>
        <!-- /#sidebar-wrapper -->
...
$register_form = '					<form role="form" method="POST" id="addUser_form" action="submit.php" >
...
<input type="hidden" name="flag" value="addUser"><input type="hidden" id="InputExternal" name="external" value="true">
							  </div>
...
$bootstrap_js_enable = '<script src="js/jquery.js"></script>';
?>
<!DOCTYPE html>
<html lang="en"><Head>
	...
	<div class="modal fade" id="register" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	  <div class="modal-dialog">
		...
		<h4 class="modal-title" id="myModalLabel">Register</h4>
	      ...
	      <div class="modal-body">
		<?php echo $register_form;//echo sha1('abcdef'); ?>
	      </div>
	    </div>
	  </div>
	</div>
